<section class="bg-[#faf9f7] px-6 pt-16 pb-0">
  <div class="max-w-[1400px] mx-auto">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
      <div class="lg:col-span-7">
        <h1 class="font-serif text-5xl md:text-6xl lg:text-[64px] leading-[1.1] tracking-tight text-gray-900">
          Real-time blockchain intelligence via composable data streams
        </h1>
      </div>
      <div class="lg:col-span-5 flex flex-col justify-between">
        <p class="text-gray-600 text-lg max-w-md leading-relaxed">
          Build DeFi apps with pre-indexed data from 50+ blockchains, serverless calculations, and automated cross-chain actions. Zero infrastructure overhead.
        </p>
      </div>
    </div>
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-8 border-t border-gray-200 pt-6">
      <div class="flex items-center gap-4">
        <button class="bg-gray-900 text-white px-6 py-3 rounded text-sm font-medium hover:bg-gray-800 transition-colors">
          Start building
        </button>
        <span class="text-xs text-gray-600 max-w-[120px] leading-tight">
          Free tier available
        </span>
      </div>
      <div class="text-[10px] text-gray-500 uppercase tracking-wider">
        50+ BLOCKCHAINS • SUB-SECOND LATENCY
      </div>
    </div>

    <div class="relative w-full h-[700px] overflow-hidden rounded-sm bg-[#2a2418]">
      <!-- Image Overlay -->
      <img 
        src="/generated/image-abstract-visualization-of-interconnected-1765592022043-0.webp" 
        alt="Blockchain network visualization" 
        class="absolute inset-0 w-full h-full object-cover opacity-30 mix-blend-overlay"
      />
      <div class="absolute inset-0 bg-gradient-to-tr from-[#1f1b15]/95 via-[#332d24]/70 to-[#4d4439]/50"></div>
      
      <!-- Network Flow Visualization -->
      <svg class="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 1400 700" fill="none" preserveAspectRatio="xMidYMid meet">
        <!-- Data flow curves from left (blockchains) to center (Rebar) to right (apps) -->
        <path d="M100,200 Q400,180 700,350" stroke="oklch(0.723 0.23 136)" stroke-width="1.5" stroke-opacity="0.5" vector-effect="non-scaling-stroke" />
        <path d="M100,300 Q400,320 700,350" stroke="oklch(0.723 0.23 136)" stroke-width="1.5" stroke-opacity="0.5" vector-effect="non-scaling-stroke" />
        <path d="M100,400 Q400,380 700,350" stroke="oklch(0.723 0.23 136)" stroke-width="1.5" stroke-opacity="0.5" vector-effect="non-scaling-stroke" />
        <path d="M100,500 Q400,480 700,350" stroke="oklch(0.723 0.23 136)" stroke-width="1.5" stroke-opacity="0.4" vector-effect="non-scaling-stroke" />
        
        <path d="M700,350 Q1000,320 1300,200" stroke="oklch(0.792 0.22 138)" stroke-width="1.5" stroke-opacity="0.5" vector-effect="non-scaling-stroke" />
        <path d="M700,350 Q1000,350 1300,300" stroke="oklch(0.792 0.22 138)" stroke-width="1.5" stroke-opacity="0.5" vector-effect="non-scaling-stroke" />
      ...
      <!-- Labels for the flow -->
      <div class="absolute top-[25%] left-[5%] text-[#f5f3ef]/70 text-xs">
        <div class="flex items-center gap-2 mb-2">
          <div class="w-[2px] h-3 bg-[#f5f3ef]/70"></div>
          <span class="tracking-wider uppercase">Blockchains</span>
        </div>
        <div class="text-[10px] text-[#f5f3ef]/50 space-y-1 ml-4">
          <div>Ethereum</div>
          <div>Solana</div>
          <div>Cosmos</div>
          <div class="opacity-60">+47 more</div>
        </div>
      </div>

      <!-- Center - Rebar -->
      <div class="absolute top-[45%] left-[50%] transform -translate-x-1/2 -translate-y-1/2">
        <div class="flex flex-col items-center gap-2 text-[#f5f3ef]/90 text-[10px] tracking-[0.2em] font-medium uppercase">
          <div class="w-[2px] h-3 bg-[#f5f3ef]/90"></div>
          <div>Rebar Network</div>
          <div class="text-[9px] text-[#f5f3ef]/60 tracking-normal normal-case">Real-time intelligence layer</div>
        </div>
      </div>

      <!-- Right side - Applications -->
      <div class="absolute top-[25%] right-[5%] text-right text-[#f5f3ef]/70 text-xs">
        <div class="flex items-center justify-end gap-2 mb-2">
          <span class="tracking-wider uppercase">Your Apps</span>
          <div class="w-[2px] h-3 bg-[#f5f3ef]/70"></div>
        </div>
        <div class="text-[10px] text-[#f5f3ef]/50 space-y-1 mr-4">
          <div>DeFi Protocols</div>
          <div>Trading Bots</div>
          <div>Analytics</div>
          <div class="opacity-60">Monitoring</div>
        </div>
      </div>
    </div>
  </div>
